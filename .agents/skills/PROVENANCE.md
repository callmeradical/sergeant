...
The seven upstream skill directories in this canonical `.agents/skills` tree
were imported unchanged from the local `agents` installation recorded in
`~/.agents/.skill-lock.json` on 2026-07-21.
That lock identifies [mattpocock/skills](https://github.com/mattpocock/skills)
as their source. The source repository declares the MIT License and

...
func (p *proxy) sendOverSocket(line string) (*response, error) {
	...
	// Performance optimization: use strings.NewReader(line) instead of bytes.NewReader([]byte(line)) to eliminate slice allocation and GC pressure in this hot path.

# work-analytics Specification

## Purpose
Give an operator aggregate visibility into recorded work — run counts by
outcome and work type, agent/model/provider provenance, and shipped-vs-total
bullet counts — scoped by project the same way the rest of the dashboard is,
without reading individual run records by hand.
## Requirements
